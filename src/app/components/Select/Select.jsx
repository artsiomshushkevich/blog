...
export const Select = ({ className = '', id, label, value = '', onChange, options }) => {
    ...
    return (
        <div className={className}>
            ...
            <div
                className={`
                    relative inline-block w-full max-w-44 after:content-[''] after:block after:absolute 
            ...
            >
                <select
                    id={id}
                    className={
                        'mt-2 py-1 pl-2 pr-5 w-full appearance-none rounded-md bg-inherit text-white border border-white'
                    }
